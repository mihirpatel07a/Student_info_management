<%@ Page Title="" Language="C#" MasterPageFile="~/pages/Admin.Master" AutoEventWireup="true" CodeBehind="UpdateBranch.aspx.cs" Inherits="SMI_Client.pages.UpdateBranch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MyContent" runat="server">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <h1 class="text-center">Update Branch </h1>
        ...
        <div class="row">
            ...
            <div class="col p-3">
                <img class="align-items-center p-4  mx-auto d-block" style="height: 450px" src="https://img.freepik.com/premium-vector/young-student-programmer-writing-code-computer_316839-1930.jpg?w=2000" />
            </div>
        </div>
    </div>
</asp:Content>
